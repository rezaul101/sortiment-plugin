	...
	<div class="main-div-row login-row">
		<div class="left-side">			
			...
			<div class="button-div">
				<a class="btn outline-btn" href="/registation"> Create Account</a>
			</div>
		...
		<div class="right-side">	
			...
			<form action=""  method="post" id="userLoginFrom" >
				<div class="full-div">
				<div class="half-div"> <span class="c_icon c-user"></span> <input type="text" id="username" name="username" placeholder="Enter username or emailaddress"> </div>		
				</div>
				<div class="full-div">
				...
				<div class="full-div">
					...
					<input class="btn blue-btn" type="submit" id="submit" name="submit" value="<?php esc_attr_e( 'Login', 'softx-sortiment' ); ?>">
				</div>
			</form>
			<h3 class="blue-subtitle"> <a href="/registation"> Create account </a> </h3>
		</div> <!-- left side end -->
	</div>  <!-- row end -->
</div>  <!-- section end -->
