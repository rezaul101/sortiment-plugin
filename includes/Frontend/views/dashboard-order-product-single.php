...
?>
		        ...
		        <div class="product-image-text-div">
		            <div class="product-image-div">
		                ...
		                <div class="product-image-thumbnail">
		                    ...
		                    <img src="<?php echo SF_SORTIMENT_ASSETS ?>/images/red-shirt.jpg" calss="productthumb">
		                    <img src="<?php echo SF_SORTIMENT_ASSETS ?>/images/blue-shirt.jpg" calss="productthumb">
		                    <img src="<?php echo SF_SORTIMENT_ASSETS ?>/images/green-shirt.jpg" calss="productthumb">
		                </div>
		            </div>
	...
	<div class="form-popup" id="myForm">
		<form action="#" class="form-container request-price-form">
			...
			<label for="title"><b>Where do you want your logo position ?</b></label>
			...
			<a class="btn blue-btn requestbtn" href="#"> Request price </a>
