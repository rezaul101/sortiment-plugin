	...
	<div class="main-div-row login-row">
		...
		<div class="right-side">	
			...
			<form action="" method="post" id="userRegistationFrom">
				...
				<div class="full-div">
				<div class="half-div"> <span class="c_icon c-envelope"></span> <input type="text" id="email" name="email" placeholder="Email"> </div>
				...
				<div class="full-div">
            		...
            		<input class="btn blue-btn" type="submit" name="submit" value="<?php esc_attr_e( 'Create account', 'softx-sortiment' ); ?>">
				</div>
			</form>
