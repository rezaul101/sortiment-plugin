	...
	<div class="main-div-row login-row">
		<div class="left-side">			
			...
			<div class="button-div">
				<a class="btn outline-btn" href="index.html"> Create Account</a>
			</div>
		...
		<div class="right-side">	
			...
			<form action="#">
				<div class="full-div">
				<div class="half-div"> <span class="c_icon c-user"></span> <input type="text" id="fname" name="fname" placeholder="Enter username or emailaddress"> </div>		
				</div>
				<div class="full-div">
				<div class="half-div"> <span class="c_icon c-key"></span> <input type="text" id="fname" name="fname" placeholder="Password"> </div>				
				</div>

				<div class="full-div">
					<a class="btn blue-btn" href="/order-dashboard-one.php">Login </a>
				</div>
			</form>
			<h3 class="blue-subtitle"> <a href="index.html"> Create account </a> </h3>
		</div> <!-- left side end -->
	</div>  <!-- row end -->
</div>  <!-- section end -->
<?php get_footer(); ?>